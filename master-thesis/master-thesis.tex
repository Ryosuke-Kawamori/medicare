...
%%% Supervisors %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\supervisors{Aki-Hiro Sato}{Program Specific Associate Professor}             % First supervisor  {name}{title}
...
\Figref{fig:out-map} shows outliers which we found by using the proposed method in 1st world grid 30617.
